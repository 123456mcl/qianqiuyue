 ...
 * @LastEditTime: 2024-01-07 17:06:45
...
<template>
    ...
    <div v-masonry v-if="istrue" class="animate__animated animate__fadeIn" id="imgbox" style="min-height: 6rem;">
            <div  id="imgboxImg" class="wow animate__zoomIn" data-wow-duration="1s" data-wow-delay=".5s" v-masonry-tile v-for="item in data.slice(num.num1,num.num2)" :fit-width="false" :key="item.img_id" style="margin-left: .14rem;margin-top: .3rem;">
...
const btn=(e:any)=>{
    ...
    router.push({
        path:'/Wallpaper/hot/hottestListHot',
        query:{
		  data:datas,
          id:e[0],
          name:e[1],
