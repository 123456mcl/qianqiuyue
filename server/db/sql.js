 ...
 * @LastEditTime: 2024-01-16 21:14:14
...
let user = {
    ...
    //用户发布壁纸
    photogallery:"insert into photogallery (name,img_type,img_url,img_time,img_collection,img_id,information_id,img_introduce,img_like,img_exegesis,isDownload) values (?,?,?,?,?,?,?,?,?,?,?)",
  };
